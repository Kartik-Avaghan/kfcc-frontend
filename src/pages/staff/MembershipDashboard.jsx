...
import { Eye, FileText, Loader2, Users, Phone, CheckCircle } from "lucide-react";
  ...
  <div className="grid grid-cols-1 gap-6">
    {memberships.map((member) => (
      <div
        ...
        className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border-l-4 border-blue-600 overflow-hidden"
      >
