...
function VoteTitleRegistrationForm({ voteApplicationId, onCloseVote, onVoteSuccess }) {
  ...
  const submitVote = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_BASE_URL}/title/meetings/${meeting.id}/vote`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      >
        ...
        <div className="bg-blue-600 text-white p-6 relative">
          ...
          <div className="flex items-center gap-3 pr-10">
            ...
            <div>
              <h2 className="text-xl font-bold">Title Committee Vote</h2>
...
export default VoteTitleRegistrationForm;
