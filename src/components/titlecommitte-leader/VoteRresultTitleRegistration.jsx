...
import TitleRegistrationAccept from "../titleregistrationformView/TitleRegistrationAccept";
import TitleRegistrationRemark from "../titleregistrationformView/TitleRegistrationRemark";
import TitleRegistrationReject from "../titleregistrationformView/TitleRegistrationReject";



function VoteRresultTitleRegistration({
    ...
    const fetchActiveMeeting = async () => {
      try {
        const res = await fetch(
          `${import.meta.env.VITE_API_BASE_URL}/title/meetings/status?status=ACTIVE`,
          {
  ...
  useEffect(() => {
    ...
    const fetchVoteSummary = async () => {
      try {
        setLoading(true);
        const res = await fetch(
          `${import.meta.env.VITE_API_BASE_URL}/title/meetings/${meeting.id}/votes/${acceptForApplicationId}`,
          {
            headers: { Authorization: localStorage.getItem("token") },
          }
        );
...
export default VoteRresultTitleRegistration;
