...
function PublicityClearenceRemark({ applicationId, onCloseRemark, onSuccess  }) {
  const [remark, setRemark] = useState("");

  function handleSubmit(e) {
    e.preventDefault();

    fetch(`${import.meta.env.VITE_API_BASE_URL}/publicityClearance/${applicationId}/action`, {
      method: "POST",
      headers: {
...
export default PublicityClearenceRemark;
